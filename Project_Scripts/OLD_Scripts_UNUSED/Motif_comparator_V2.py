...
if datasetprompt == "both" or datasetprompt == "Both" or datasetprompt == "BOTH":
    ...
    newgraphout = f"Thesis_project_data\\Data\\Processed_data\\V{versionprompt}_Network_graphs_bothgenomes_mastupdated"
    mergedclustersout = f"Thesis_project_data\\Data\\Processed_data\\V{versionprompt}_mast_merged_igrs_bothgenomes"
    ...
    newgraphout = f"Thesis_project_data\\Data\\Processed_data\\V{versionprompt}_Network_graphs_compgenomes_mastupdated"
    mergedclustersout = f"Thesis_project_data\\Data\\Processed_data\\V{versionprompt}_mast_merged_igrs_compgenomes"
    mastloc =  "Thesis_project_data\\Data\\Processed_data\\mastout"
    if os.path.isdir(newgraphout) == False:
        os.mkdir(newgraphout)
    if os.path.isdir(mergedclustersout) == False:
